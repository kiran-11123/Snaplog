   ...
   const title: string = searchParams.get('title') ?? "Default";
    ...
    return(
         ...
         <div className="bg-gray-100  flex  flex-col justify-between w-full">
            ...
            <h1 className="font-serif px-4 py-2 rounded-lg shadow-2xl bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-[#27272a] via-[#52525b] to-[#a1a1aa] text-blue-800">Recently Deleted : {title}</h1>
